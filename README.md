# AngularJS Pasqua Jove Web App

## Overview

This web is for the XX Pasqua Jove
...
- At this moment, there is no dynamic backend (no application server) for this application. Instead we fake the
